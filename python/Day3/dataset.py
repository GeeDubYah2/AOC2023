# The initial test input from the problem description
# Used in unittests to validate the logic.
#
TEST_INPUT = '''
467..114..
...*......
...
# The full problem test input.
# Same input is used for parts one and two of this problem.
#
FULL_INPUT = '''
