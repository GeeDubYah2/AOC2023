...
class TestDay5_1 (unittest.TestCase):
    ...
    def test_Hand_countCardsAndScore( self ):
        # Ace Trips
        hand1 = Hand( 'AKQAA', 0 )
        self.assertEqual( hand1.cardCounts, [Hand.CardCount(14,3), Hand.CardCount(13,1), Hand.CardCount( 12, 1 ) ] )
        self.assertEqual( hand1.score,      HANDS['Trips'] )
        ...
        # Rank above is...
        # hand3 (5ofKind), hand1 (trips AKQAA), hand2 (trips 2K2A2), hand4 (highcard 234KA), hand5 (highcard 234KQ)
        hands = [hand5,hand4,hand3,hand2,hand1]
        self.assertEqual( Hand.rankHands(hands), [hand3, hand1, hand2, hand4, hand5] )

    def test_playGame( self ):
        self.assertEqual( 6440, playGame( EXAMPLE_INPUT ) )

        self.assertEqual(253910319, playGame(PUZZLE_INPUT)) ### THE ANSWER ###
